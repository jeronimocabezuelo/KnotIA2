...
class X:
    ...
    def __eq__(self, obj):
        if type(self) != type(obj):
            return False
        c1 = self.strands[0] == obj.strands[0] and self.strands[1] == obj.strands[
            1] and self.strands[2] == obj.strands[2] and self.strands[3] == obj.strands[3]
        c2 = self.strands[0] == obj.strands[2] and self.strands[1] == obj.strands[
            3] and self.strands[2] == obj.strands[0] and self.strands[3] == obj.strands[1]
        return c1 or c2
